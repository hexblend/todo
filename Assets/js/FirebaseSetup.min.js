function GetDate() {
    var e = new Date(),
        ...
        r = e.getFullYear();
    return (
        a < 10 && (a = "0" + a), t < 10 && (t = "0" + t), a + "/" + t + "/" + r
    );
}
function AddToList(e) {
    var a = { Name: e, Checked: !1 };
    GlobalData.CurrentList.CurrentDate.push(a);
}
function CheckListElem() {}
function UnCheckListElem() {}
function SetFireBaseList(e) {}
...
firebase.auth().useDeviceLanguage(),
    firebase
        ...
        .getRedirectResult()
        .then(function(e) {
            e.credential && (FB_DATA.Token = e.credential.accessToken),
                (FB_DATA.User = e.user),
    ...
    firebase.auth().onAuthStateChanged(function(e) {
        if (e)
            if (
                ...
                "/todo/login.html" == location.pathname)
            )
                location.pathname = "/todo/index.html";
            else {
                var a = document.querySelector("#LogOutButton");
                a &&
                    ...
                    firebase
                        ...
                        .on("value", function(e) {
                            console.log(e.val()),
                                (GlobalData.UserData.AllLists = e.val());
                        });
            }
        else if (
            (console.log("User Log In Required."),
            "/todo/index.html" == location.pathname)
        )
            location.pathname = "/todo/login.html";
        else {
            var t = document.querySelector("#LoginButton");
            t &&
